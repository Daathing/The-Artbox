<?php
    ...
    $oeuvre3 = [
        'picture' => '<img src="img/dan-cristian-padure.png" alt="Nightlife Traffic">',
        'title' => '<h2>Nightlife Traffic</h2>',
        'artist' => '<p class="description">Andrew Forsythe</p>',
    ...
    $oeuvre4 = [
        'picture' => '<img src="img/steve-johnson-5.png" alt="Le refuge de l\'Havre">',
        'title' => '<h2>Le refuge de l\'Havre</h2>',
        'artist' => '<p class="description">Simon Pelletier</p>',
    ...
    $oeuvre5 = [
        'picture' => '<img src="img/steve-johnson.png" alt="Red Washover">',
        'title' => '<h2>Red Washover</h2>',
        'artist' => '<p class="description">Kit Van Der Borght</p>',
    ...
    $oeuvre6 = [
        'picture' => '<img src="img/pawel-czerwinski.png" alt="Chromatics">',
        'title' => '<h2>Chromatics</h2>',
        'artist' => '<p class="description">Jean-Michel Delatronchette</p>',
    ...
    $oeuvre7 = [
        'picture' => '<img src="img/jazmin-quaynor.png" alt="Digital Negative">',
        'title' => '<h2>Digital Negative</h2>',
        'artist' => '<p class="description">Hamish McKee</p>',
    ...
    $oeuvre8 = [
        'picture' => '<img src="img/steve-johnson-6.png" alt="Blast from the past">',
        'title' => '<h2>Blast from the past</h2>',
        'artist' => '<p class="description">Juliette Baskerville</p>',
    ...
    $oeuvre9 = [
        'picture' => '<img src="img/victor-grabarczyk.png" alt="Hurricane">',
        'title' => '<h2>Hurricane</h2>',
        'artist' => '<p class="description">Natalie Wellington</p>',
    ...
    $oeuvre10 = [
        'picture' => '<img src="img/pawel-czerwinski-2.png" alt="La marée rouge">',
        'title' => '<h2>La marée rouge</h2>',
        'artist' => '<p class="description">Martin Rodriguez</p>',
    ...
    $oeuvre11 = [
        'picture' => '<img src="img/steve-johnson-2.png" alt="Asimilacion">',
        'title' => '<h2>Asimilacion</h2>',
        'artist' => '<p class="description">Angel Sanchez-Fernandez</p>',
    ...
    $oeuvre12 = [
        'picture' => '<img src="img/fly-d.png" alt="La Galaxia Gialla">',
        'title' => '<h2>La Galaxia Gialla</h2>',
        'artist' => '<p class="description">Eduardo Tancredi</p>',
    ...
    $oeuvre13 = [
        'picture' => '<img src="img/orfeas-green.png" alt="Puffy Amalgamate">',
        'title' => '<h2>Puffy Amalgamate</h2>',
        'artist' => '<p class="description">Sandro De Blasi</p>',
    ...
    $oeuvre14 = [
        'picture' => '<img src="img/steve-johnson-4.png" alt="Mirage">',
        'title' => '<h2>Mirage</h2>',
        'artist' => '<p class="description">Stéphanie Kaiser</p>',
    ...
    $oeuvre15 = [
        'picture' => '<img src="img/steve-johnson-3.png" alt="Blaue Gelbe Muster">',
        'title' => ' <h2>Blaue Gelbe Muster</h2>',
        'artist' => '<p class="description">Adelheid Von Schreiber</p>',
    ...
    $oeuvres = ['$oeuvre1', '$oeuvre2', '$oeuvre3', 
                '$oeuvre4', '$oeuvre5', '$oeuvre6', 
                '$oeuvre7', '$oeuvre8', '$oeuvre9', 
                '$oeuvre10', '$oeuvre11', '$oeuvre12', 
                '$oeuvre13', '$oeuvre14', '$oeuvre15'];
?>
