<?php
    ...
    // Exemple de Kévin (mentor) d'un tableau associatif dans un tableau numéroté et d'une boucle foreach
    ...
    foreach($tableau as 'id => $infos) {
        echo '<p>Le '.$infos['animal'].' il '.$infos['cri'].', nous sommes sur l\'entrée n°'.'id.'</p>';
    } */